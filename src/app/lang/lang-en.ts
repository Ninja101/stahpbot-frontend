...
export const LANG_EN_TRANS = {
	...
	'dashboard.manage_alerts.reload_alert': 'Reload Alert Overlays',
	...
	'help.command.format': 'This is the format the value will be nested in when "Allow editing via chat" is enabled.\nFor example, if the current value is 1337 and the format is set to "Number is: {value}" - Whenever someone uses the command, it will output: "Number is: 1337"',
	...
	'help.command.visible': 'Will be visible in the public commands list',
	'help.command.editable': 'If enabled, moderators can edit the value of the command from chat by putting the new text after the command.\nExample: "!command ASD" will set the value to "ASD"',
	...
	'help.message.interval': 'Number of seconds after which this scheduled message will posted to chat',
	'help.message.only_live': 'When checked, the message will only output at the set interval if your stream is online',
	...
	'help.message.type.scheduled': 'This message will be posted into chat every time the specified interval has elapsed',
	...
	'help.message.type.new_tweet': `<b>Replacement Keywords</b><br />
		<ul>
			<li>{name} - Twitter username</li>
			<li>{text} - Text of the tweet</li>
		</ul>
		<br />
		<b>Example:</b><br />
		<code>New tweet from {name}: {text}</code><br />
		-><br />
		<code>New tweet from Ninja101_: This is a tweet!</code>`,
	'help.message.type.new_youtube': `<b>Replacement Keywords</b><br />
		<ul>
			<li>{title} - YouTube video title</li>
			<li>{url} - YouTube video URL</li>
		</ul>
		<br />
		<b>Example:</b><br />
		<code>My new video is out! {title} - {url}</code><br />
		-><br />
		<code>My new video is out! YouTube Test Video - http://youtu.be/ARealYouTubeId</code>`,
};